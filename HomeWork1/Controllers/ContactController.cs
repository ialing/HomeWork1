...
namespace HomeWork1.Controllers
{
    public class ContactController : Controller
    {
        ...
        public ActionResult Index(string search)
        {
            ...
            客戶聯絡人 = db.客戶聯絡人.Where(c => (bool)!c.刪除註記 );

            if (!string.IsNullOrEmpty(search)) 
            {
                //客戶聯絡人 = db.客戶聯絡人.Where(c => c.客戶資料.客戶名稱.Contains(search));
                客戶聯絡人 = db.客戶聯絡人.Where(c =>c.姓名.Contains(search));
        ...
        {
            var data = db.客戶資料.Where(c => (bool)!c.刪除註記);
